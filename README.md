...
- <a href='https://github.com/swsoyee/highlightjs-spl' target='_blank'>✨ highlighjs-spl</a>: [highlight.js](https://highlightjs.org/) syntax definition for the [Splunk search processing language (SPL)](https://docs.splunk.com/Splexicon:SPL)
   [![JavaScript](https://img.shields.io/badge/-565454?logo=JavaScript&link=https://github.com/swsoyee/highlightjs-spl)](https://github.com/swsoyee/highlightjs-spl) [![WIP](https://img.shields.io/badge/WIP-0.1.0-brightgreen?link=https://github.com/swsoyee/highlightjs-spl)](https://github.com/swsoyee/highlightjs-spl)
