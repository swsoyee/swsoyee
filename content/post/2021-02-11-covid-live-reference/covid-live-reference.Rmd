---
title: "「新型コロナウイルス感染速報」が引用元になった資料達"
author: "Su Wei"
date: "2021-02-11"
output: html_document
categories: [日本語]
tags: [covid19,achievement]
summary: 'この記事には、自分が開発した「新型コロナウイルス感染速報」を紹介している資料達のまとめです。自分が把握している限りの全てではないですが、「感染速報」が皆さんに信頼されていることを示されています。ツイター上に `covid-2019.live` でエゴサーチすればもっと出てくると思います。'
---
